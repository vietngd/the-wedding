...
const DOMAIN = process.env.NEXT_PUBLIC_BASE_URL || "https://the-wedding-viet-thoa.vercel.app/"; // Lưu ý: Không để dấu gạch chéo (/) ở cuối
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${DOMAIN}/images/wedding/wedding-24.jpg`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Thiệp Cưới - Đức Việt & Thoa Nguyễn",
    description: "Hân hoan thông báo lễ cưới của Đức Việt & Thoa Nguyễn. Chúng tôi trân trọng kính mời bạn đến chung vui.",
    images: [`${DOMAIN}/images/wedding/wedding-24.jpg`],
  },
};
